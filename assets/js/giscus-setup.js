...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const giscusConfig = {
    ...
    inputPosition: '{{ site.giscus.input_position | default: "bottom" }}',
    theme: getGiscusTheme(),
    lang: '{{ site.giscus.lang | default: "en" }}'
  };
...
function getGiscusTheme() {
  ...
  if (isDarkMode) {
    return '{{ site.giscus.dark_theme | default: "dark" }}';
  } else {
    return '{{ site.giscus.light_theme | default: "light" }}';
  }
}
